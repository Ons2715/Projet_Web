...
import { createUser, deleteUser, getOneUser, listAllUsers, updateCurrentUserFormation, updateCurrentUserPhoto, updateCurrentUserProfile } from "../controllers/userController.js";
...
userRouter.patch("/me", requireAuth, asyncHandler(updateCurrentUserProfile));
